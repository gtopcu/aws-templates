...
def execute_delete_item(dynamodb_client, input):
    try:
        ...
        print("Unknown error while deleting item: " + error.response['Error']['Message'])

# QUERY
def create_query_input():
    return {
        "TableName": "sessions",
        "KeyConditionExpression": "#e2240 = :e2240",
        "ExpressionAttributeNames": {"#e2240":"sessionID"},
        "ExpressionAttributeValues": {":e2240": {"S":"sessionID"}}
    }
...
def main():
    ...
    dynamodb_client = create_dynamodb_client(region="eu-east-2")
